...
public final class PhoneNumberFactory extends RandomNumberFactory{
    ...
    public static PhoneNumber[] createRandomPhoneNumberArray(int phoneNumberCount) {
        PhoneNumber[] randomPhoneNumberArr = new PhoneNumber[phoneNumberCount];
        for(int i=0; i < randomPhoneNumberArr.length; i++) {
            randomPhoneNumberArr[i] = createRandomPhoneNumber();
        }
        return randomPhoneNumberArr;
    }
    ...
    public static PhoneNumber createPhoneNumberSafely(int areaCode, int centralOfficeCode, int phoneLineCode) {
        ...
        safePhoneNumber = "(" + areaCode + ")-" + centralOfficeCode + "-" + phoneLineCode;
        try {
